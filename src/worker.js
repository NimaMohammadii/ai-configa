...
function isAdminPhotoAction(action) {
  return ["voice_profile", "credit_page_image", "mini_app_icon", "channel_post", "image_explore_image", "image_explore_prompt", "image_explore_tags", "message", "broadcast"].includes(action?.action);
}
