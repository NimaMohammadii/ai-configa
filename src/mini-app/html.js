...
<body>
  ...
  <section id="voicesPage" class="voices-page" aria-hidden="true"><header class="voices-page-head"><div><span>VOICE LIBRARY</span><h2>Voices</h2></div><div class="voices-page-count"><strong id="savedVoiceCount">1</strong><span>/ 6 saved</span></div></header><label class="voice-library-search" for="voiceLibrarySearch"><span class="voice-search-glow" aria-hidden="true"></span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="10.8" cy="10.8" r="6.3" stroke="currentColor" stroke-width="1.9"/><path d="m15.5 15.5 4 4" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/></svg><input id="voiceLibrarySearch" type="search" autocomplete="off" placeholder="Search voices..."/><button class="voice-search-clear" data-action="clear-voice-search" type="button" aria-label="Clear voice search">×</button></label><section class="saved-voices-strip"><div class="saved-voices-copy"><strong>Your voices</strong><small>Available in the quick menu</small></div><div id="savedVoiceAvatars" class="saved-voice-avatars"></div></section><div class="voice-library-grid">${VOICE_LIBRARY_CARDS}</div></section>
