...
<head>
  ...
  <link rel="stylesheet" href="/mini-app/styles.css?v=20260719-19"/>
</head>
<body>
  <main class="app">
      ...
      <div class="tts-page">
        ...
        <section id="imageWorkspace" class="image-workspace" aria-hidden="true">
          ...
          <div class="image-composer">
            ...
            <div class="image-composer-foot"><span id="imagePromptCount">0 / 2000</span><div class="image-composer-tools"><div id="imageSizePicker" class="image-size-picker"><button id="imageSizeToggle" class="image-size-toggle" data-action="toggle-image-size" type="button" aria-label="Image size: Square" aria-expanded="false"><span id="selectedSizeShape" class="size-shape size-square" aria-hidden="true"></span></button><div class="image-size-menu" role="menu" aria-label="Choose output size"><button class="image-size-option active" data-action="select-image-size" data-image-size="1024x1024" type="button" role="menuitem" aria-pressed="true"><span class="size-shape size-square" aria-hidden="true"></span><span><strong>Square</strong><small>1:1</small></span></button><button class="image-size-option" data-action="select-image-size" data-image-size="1024x1536" type="button" role="menuitem" aria-pressed="false"><span class="size-shape size-portrait" aria-hidden="true"></span><span><strong>Portrait</strong><small>2:3</small></span></button><button class="image-size-option" data-action="select-image-size" data-image-size="1536x1024" type="button" role="menuitem" aria-pressed="false"><span class="size-shape size-landscape" aria-hidden="true"></span><span><strong>Wide</strong><small>3:2</small></span></button></div></div><button class="image-upload-trigger" data-action="pick-image" type="button"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 16V4m0 0L7.5 8.5M12 4l4.5 4.5M5 13.5v4A2.5 2.5 0 0 0 7.5 20h9a2.5 2.5 0 0 0 2.5-2.5v-4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg><span>Add image</span></button></div></div>
          </div>
  ...
  <script type="module" src="/mini-app/app.js?v=20260719-19"></script>
</body>
</html>`;
