...
<head>
  ...
  <link rel="stylesheet" href="/mini-app/styles.css?v=20260721-41"/>
</head>
<body>
  <main class="app">
    <section id="flow" class="view active">
      <div class="tts-page">
        <div class="tts-head">
          <div class="credit-tools"><div class="credit-pill"><span id="balance">—</span><span>credits</span></div></div>
        ...
        <div class="tts-area dialogue-editor" id="dialogueEditor">
          <section class="dialogue-turn active" data-dialogue-turn data-dialogue-id="1" data-voice="${VOICES.Liam}" data-voice-name="Liam">
            ...
            <div class="dialogue-input-wrap">
              <textarea id="ttsText" class="dialogue-text" data-dialogue-text dir="ltr" placeholder="Type something"></textarea>
            </div>
        ...
        <section id="imageWorkspace" class="image-workspace" aria-hidden="true">
          ...
          <section id="imageExplore" class="image-explore" aria-hidden="true"><div class="image-explore-head"><span>Explore</span><small id="imageExploreCount">0 cards</small></div><div id="imageExploreGrid" class="image-explore-grid"></div></section>
  ...
  <script type="module" src="/mini-app/app.js?v=20260721-35"></script>
</body>
</html>`;
