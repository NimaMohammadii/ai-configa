          ...
          <section id="ttsAudioEditor" class="tts-audio-editor" aria-hidden="true">
            ...
            <div class="tts-audio-editor-actions">
              <div class="tts-audio-editor-tools">
                ...
                <button id="ttsAudioRedo" data-action="redo-audio-edit" type="button" aria-label="Redo edit" disabled><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M15 8h4V4m-.4 4.1A8 8 0 1 0 19.8 14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
              </div>
