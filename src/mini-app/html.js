...
<head>
  ...
  <link rel="stylesheet" href="/mini-app/styles.css?v=20260729-balanced-timeline-10"/>
</head>
<body>
  <main class="app">
      ...
      <div class="tts-page">
        ...
        <div class="tts-bottom">
          <div class="player-history-row">
            ...
            <div class="wave-meta"><span class="wave-time" id="waveTime">0:00</span><i aria-hidden="true">/</i><span class="wave-duration" id="waveDuration">0:00</span></div></div>
  ...
  <script type="module" src="/mini-app/app.js?v=20260729-balanced-timeline-10"></script>
</body>
</html>`;
