...
<head>
  ...
  <link rel="stylesheet" href="/mini-app/styles.css?v=20260726-credits-spacing-06"/>
</head>
<body>
  <main class="app">
      ...
      <div class="tts-page">
        ...
        <div class="tts-bottom">
          ...
          <div class="tts-generate-row">
            <button id="convertButton" class="tts-generate" data-action="generate-tts" type="button"><span class="tts-generate-label">Generate Voice</span><span class="tts-generate-loader" aria-hidden="true"><i></i><i></i><i></i></span></button>
