    ...
    <section id="flow" class="view active">
      <div class="tts-page">
        ...
        <section id="imageWorkspace" class="image-workspace" aria-hidden="true">
          ...
          <section id="imageExplore" class="image-explore" aria-hidden="true"><div class="image-explore-head"><button class="image-explore-title" data-action="open-explore-page" type="button">Explore</button></div><div id="imageExploreGrid" class="image-explore-grid"></div></section>
