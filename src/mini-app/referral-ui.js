export const REFERRAL_UI_PATCH = String.raw`
  ...
  function referralAppendAiChatOffer(status,anchor){
    ...
    offer.innerHTML='<section class="ai-chat-referral-card"><div class="ai-chat-referral-title"><span class="ai-chat-referral-alert" aria-hidden="true"><span>!</span></span><strong></strong></div><div class="ai-chat-referral-head"><span class="ai-chat-referral-reward"></span><span class="ai-chat-referral-count"><span></span><strong></strong></span></div><p class="ai-chat-referral-copy"></p><div class="ai-chat-referral-dots" aria-hidden="true"><i class="ai-chat-referral-dot"></i><i class="ai-chat-referral-dot"></i><i class="ai-chat-referral-dot"></i></div><button class="ai-chat-referral-share" type="button"><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 15.5V4m0 0L7.8 8.2M12 4l4.2 4.2M5.5 13.5v4A2.5 2.5 0 0 0 8 20h8a2.5 2.5 0 0 0 2.5-2.5v-4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg><span></span></button></section>';
