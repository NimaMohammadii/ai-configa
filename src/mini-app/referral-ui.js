export const REFERRAL_UI_PATCH = String.raw`
  ...
  var referralCopies={
    en:{title:'Not enough credits',text:'Buy credits, or invite 3 friends and get 300 free credits',progress:'Friends invited',share:'Invite friends',buy:'Buy credits',sharing:'Opening share…',reward:'300 free credits',close:'Close',shareError:'Could not open sharing. Try again'},
    fa:{title:'کردیت کافی نداری',text:'یا کردیت بخر، یا ۳ تا از دوستاتو دعوت کن و ۳۰۰ کردیت رایگان بگیر',progress:'دوست‌های دعوت‌شده',share:'دعوت از دوستا',buy:'خرید کردیت',sharing:'در حال باز کردن…',reward:'۳۰۰ کردیت رایگان',close:'بستن',shareError:'اشتراک‌گذاری باز نشد؛ دوباره امتحان کن'},
    ru:{title:'Недостаточно кредитов',text:'Купи кредиты или пригласи 3 друзей и получи 300 бесплатных кредитов',progress:'Приглашено друзей',share:'Пригласить друзей',buy:'Купить кредиты',sharing:'Открываем…',reward:'300 бесплатных кредитов',close:'Закрыть',shareError:'Не удалось открыть отправку. Попробуй ещё раз'},
    de:{title:'Nicht genügend Credits',text:'Kaufe Credits oder lade 3 Freunde ein und erhalte 300 Credits gratis',progress:'Eingeladene Freunde',share:'Freunde einladen',buy:'Credits kaufen',sharing:'Teilen wird geöffnet…',reward:'300 Credits gratis',close:'Schließen',shareError:'Teilen konnte nicht geöffnet werden. Versuch es erneut'},
    tr:{title:'Yetersiz kredi',text:'Kredi satın al ya da 3 arkadaşını davet et, 300 ücretsiz kredi kazan',progress:'Davet edilen arkadaşlar',share:'Arkadaşlarını davet et',buy:'Kredi satın al',sharing:'Paylaşım açılıyor…',reward:'300 ücretsiz kredi',close:'Kapat',shareError:'Paylaşım açılamadı. Tekrar dene'},
    ar:{title:'الرصيد غير كافٍ',text:'اشترِ رصيدًا أو ادعُ 3 من أصدقائك واحصل على 300 رصيد مجانًا',progress:'الأصدقاء المدعوون',share:'دعوة الأصدقاء',buy:'شراء رصيد',sharing:'جارٍ فتح المشاركة…',reward:'300 رصيد مجانًا',close:'إغلاق',shareError:'تعذر فتح المشاركة. حاول مرة أخرى'},
    zh:{title:'积分不足',text:'购买积分，或邀请 3 位好友获得 300 免费积分',progress:'已邀请好友',share:'邀请好友',buy:'购买积分',sharing:'正在打开分享…',reward:'300 免费积分',close:'关闭',shareError:'无法打开分享，请重试'},
    ja:{title:'クレジットが足りません',text:'クレジットを購入するか、友だち3人を招待して300無料クレジットを獲得',progress:'招待した友だち',share:'友だちを招待',buy:'クレジット購入',sharing:'共有を開いています…',reward:'300無料クレジット',close:'閉じる',shareError:'共有を開けませんでした。もう一度試してください'},
    es:{title:'No tienes suficientes créditos',text:'Compra créditos o invita a 3 amigos y recibe 300 créditos gratis',progress:'Amigos invitados',share:'Invitar amigos',buy:'Comprar créditos',sharing:'Abriendo compartir…',reward:'300 créditos gratis',close:'Cerrar',shareError:'No se pudo abrir compartir. Inténtalo de nuevo'},
    hi:{title:'Credits कम हैं',text:'Credits खरीदो या 3 दोस्तों को invite करके 300 free credits पाओ',progress:'Invite किए गए दोस्त',share:'दोस्तों को Invite करें',buy:'Credits खरीदें',sharing:'Share खुल रहा है…',reward:'300 free credits',close:'बंद करें',shareError:'Share नहीं खुला। फिर से try करो'}
  };
