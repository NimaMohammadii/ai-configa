...
function bindPlayer(p){
 ...
 v.addEventListener('pause',function(){clearRenderTimer();if(!enabled)return;if(warmupActive)return;sendPlaybackState(v,false);closeSocket();clearCaptionState(p,true);});
