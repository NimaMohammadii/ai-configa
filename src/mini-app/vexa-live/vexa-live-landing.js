...
const SUBTITLE_PREFERENCE_SCRIPT = String.raw`(function(){
  ...
  function sync(){const ready=quality.dataset.ready==='1';const active=quality.querySelector('[data-quality-key][data-selected="1"]');const audio=String(active?.dataset?.qualityKey||'')==='a';shell.dataset.ready=ready?'1':'0';shell.dataset.disabled=audio?'1':'0';select.disabled=audio;}
