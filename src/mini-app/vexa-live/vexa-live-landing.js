...
.vexa-live-download-action{min-width:132px;height:48px;margin:0;padding:0 24px;${liquidGlassMaterialCss()}outline:0!important;border-radius:999px;color:rgba(255,255,255,.92);font-size:13px;font-weight:650;letter-spacing:-.01em;line-height:1;appearance:none;-webkit-appearance:none;cursor:pointer;transform-origin:center;will-change:transform,filter,opacity;transition:opacity .24s ease,transform .38s cubic-bezier(.16,1,.3,1),filter .2s ease,background .25s ease,border-color .25s ease,box-shadow .25s ease}
.vexa-upload-action{width:48px;min-width:48px;height:48px;padding:0;${liquidGlassMaterialCss()}outline:0!important;border-radius:999px;color:rgba(255,255,255,.92);display:grid;place-items:center;appearance:none;-webkit-appearance:none;cursor:pointer;transform-origin:center;will-change:transform,filter,opacity;transition:opacity .24s ease,transform .38s cubic-bezier(.16,1,.3,1),filter .2s ease,background .25s ease,border-color .25s ease,box-shadow .25s ease}
.vexa-upload-plus{display:block;font-size:27px;font-weight:760;line-height:1;letter-spacing:-.06em;transform:translateY(-1px)}
...
@media(hover:hover) and (pointer:fine){.vexa-live-download-action:hover,.vexa-upload-action:hover{transform:scale(1.045);${LIQUID_GLASS_HOVER_CSS}}}
.vexa-live-download-action:active,.vexa-upload-action:active{transform:scale(.965);filter:brightness(.9)}
...
@media(prefers-reduced-motion:reduce){.vexa-download-percent,.vexa-download-fill,.vexa-live-download-action,.vexa-upload-action,.vexa-download-quality,.vexa-quality-option,.vexa-download-subtitles{transition:none!important}}
`;
