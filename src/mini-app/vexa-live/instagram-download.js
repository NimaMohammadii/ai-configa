...
export async function appendInstagramDownloadRuntime(request, response) {
  ...
  const tag = '<script src="' + INSTAGRAM_RUNTIME_PATH + '?v=20260827-1"></script>';
