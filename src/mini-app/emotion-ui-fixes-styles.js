...
/* Move the shared mini-app top content down by 15px. */
.app{padding-top:calc(37px + env(safe-area-inset-top))!important}
.tts-head:before{top:calc(-37px - env(safe-area-inset-top))!important}
`;