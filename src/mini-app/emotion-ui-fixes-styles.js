...
/* Image creation: keep the composer detail and upload action independent from Generate. */
...
.image-upload-trigger{border:0!important;background:linear-gradient(145deg,#fff 0%,#f2f2f2 34%,#d4d4d4 66%,#f8f8f8 100%)!important;color:#050505!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.96),inset 0 -1px 0 rgba(0,0,0,.16)!important;filter:none!important;text-shadow:none!important;outline:0!important;-webkit-appearance:none!important;appearance:none!important}
.image-upload-trigger:focus,.image-upload-trigger:focus-visible,.image-upload-trigger:active{box-shadow:inset 0 1px 0 rgba(255,255,255,.96),inset 0 -1px 0 rgba(0,0,0,.18)!important;filter:none!important;outline:0!important}

/* Stars checkout keeps its own metallic finish; Generate Voice is owned by Liquid Metal. */
#customCreditsBuy.credits-primary-button{border:0!important;background:linear-gradient(145deg,#fff 0%,#f5f5f5 21%,#d8d8d8 47%,#bdbdbd 68%,#f7f7f7 100%)!important;color:#050505;box-shadow:inset 0 1px 0 rgba(255,255,255,.98),inset 0 -1px 0 rgba(0,0,0,.24),inset 1px 0 0 rgba(255,255,255,.4),0 6px 14px rgba(0,0,0,.2)!important;filter:none!important;text-shadow:none!important;outline:0!important;-webkit-appearance:none!important;appearance:none!important;font-weight:840!important;letter-spacing:-.018em!important}
#customCreditsBuy.credits-primary-button:focus,#customCreditsBuy.credits-primary-button:focus-visible,#customCreditsBuy.credits-primary-button:active{background:linear-gradient(145deg,#efefef 0%,#e0e0e0 28%,#bdbdbd 62%,#ececec 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.96),inset 0 -1px 0 rgba(0,0,0,.28),inset 1px 0 0 rgba(255,255,255,.34),0 4px 10px rgba(0,0,0,.2)!important;filter:none!important;outline:0!important}
