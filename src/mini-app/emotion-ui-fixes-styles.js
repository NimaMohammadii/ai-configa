...
.demo-language-wrap .voice-menu{top:44px!important;width:230px!important;border:0!important;border-radius:16px!important;background:rgba(13,13,13,.62)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.105),inset 0 -1px 0 rgba(255,255,255,.06),inset 0 0 18px rgba(255,255,255,.05),0 10px 22px rgba(0,0,0,.22)!important;backdrop-filter:blur(10px) saturate(1.12)!important;-webkit-backdrop-filter:blur(10px) saturate(1.12)!important}
.demo-language-button-avatar{display:contents!important}
.demo-language-button-avatar .demo-language-flag{display:block!important;width:28px!important;height:18px!important;border-radius:4px!important;box-shadow:inset 0 0 0 1px rgba(255,255,255,.2),0 2px 7px rgba(0,0,0,.28)!important}
