...
.tts-audio-editor-head{height:32px;display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin:0 2px 9px}
...
.tts-audio-clip-lane.has-multiple-clips .tts-audio-clip.active{background:rgba(199,131,255,.045);box-shadow:inset 0 0 0 1px rgba(199,131,255,.24)}
.tts-audio-clip-lane.has-multiple-clips .tts-audio-clip.pressed{transform:scale(.965);background:rgba(199,131,255,.08);box-shadow:inset 0 0 0 1px rgba(199,131,255,.42)}
...
.tts-audio-clip.dragging{opacity:.98;background:#111!important;box-shadow:0 12px 28px rgba(0,0,0,.5),inset 0 0 0 1px rgba(199,131,255,.55)!important;z-index:20;transition:none!important}
...
.tts-audio-selection::before{content:"";position:absolute;left:8px;right:8px;top:50%;height:1px;background:rgba(199,131,255,.28);transform:translateY(-50%)}
...
.tts-audio-handle i{position:absolute;top:8px;bottom:8px;width:4px;border-radius:999px;background:#fff;box-shadow:0 0 0 2px rgba(199,131,255,.13),0 0 12px rgba(199,131,255,.38)}
.tts-audio-handle i::before,.tts-audio-handle i::after{display:none}
.tts-audio-handle.start{left:0}.tts-audio-handle.start i{left:4px}.tts-audio-handle.end{right:auto;left:100%;transform:translateX(-100%)}.tts-audio-handle.end i{right:4px}
.tts-audio-handle.dragging i{width:5px;background:var(--audio-accent)}
.tts-audio-playhead{position:absolute;top:5px;bottom:5px;left:0;width:2px;background:var(--audio-accent);border-radius:999px;opacity:0;z-index:9;pointer-events:none;transform:translate3d(0,0,0) translateX(-50%);will-change:transform;transition:opacity .16s ease;box-shadow:0 0 9px rgba(199,131,255,.45)}
...
.tts-audio-editor-tools{width:100%;display:grid;grid-template-columns:42px 56px 42px;align-items:center;justify-content:center;gap:14px}
...
.tts-audio-editor-tools #ttsAudioPreview{width:56px;height:56px;border-radius:18px;background:#fff;border-color:#fff;color:#050505;box-shadow:0 10px 30px rgba(255,255,255,.09)}
.tts-audio-editor-tools svg{width:18px;height:18px}
.tts-audio-editor-tools #ttsAudioPreview svg{width:22px;height:22px}
.tts-audio-editor-operations #ttsAudioDelete:not(:disabled){color:rgba(255,118,136,.88);border-color:rgba(255,103,124,.11)}
.tts-audio-editor-operations .primary{background:linear-gradient(135deg,#d093ff,#ad62ed);border-color:rgba(215,153,255,.72);color:#08040b;font-weight:840;box-shadow:0 8px 24px rgba(165,78,226,.16)}
.tts-audio-previewing .tts-audio-editor-tools #ttsAudioPreview{background:var(--audio-accent);border-color:var(--audio-accent);box-shadow:0 10px 30px rgba(199,131,255,.2)}
