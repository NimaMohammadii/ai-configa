...
.tts-audio-editor.open{max-height:266px;margin:0;padding:2px 0 0;opacity:1;transform:translateY(0) scale(1);border:0;border-radius:22px;background:var(--ticket-glass-bg,rgba(13,13,13,.62));box-shadow:var(--ticket-glass-shadow,inset 0 1px 0 rgba(255,255,255,.105),inset 0 -1px 0 rgba(255,255,255,.06),inset 0 0 18px rgba(255,255,255,.05),0 10px 22px rgba(0,0,0,.22));pointer-events:auto}
