...
.tts-audio-editor{--audio-accent:#361248;--audio-accent-soft:rgba(105,47,148,.2);width:100%;max-height:0;margin:0;overflow:hidden;opacity:0;transform:translateY(12px) scale(.985);transform-origin:center bottom;border:0;border-radius:22px;background:var(--ticket-glass-bg,rgba(13,13,13,.62));padding:0;pointer-events:none;box-shadow:var(--ticket-glass-shadow,inset 0 1px 0 rgba(255,255,255,.105),inset 0 -1px 0 rgba(255,255,255,.06),inset 0 0 18px rgba(255,255,255,.05),0 10px 22px rgba(0,0,0,.22));backdrop-filter:blur(10px) saturate(1.12);-webkit-backdrop-filter:blur(10px) saturate(1.12);transition:max-height .5s cubic-bezier(.16,1,.3,1),opacity .22s ease,transform .46s cubic-bezier(.16,1,.3,1)}
.tts-audio-editor.open{max-height:266px;margin:0;padding:2px 0 0;overflow:visible;opacity:1;transform:translateY(0) scale(1);border:0;border-radius:22px;background:var(--ticket-glass-bg,rgba(13,13,13,.62));box-shadow:0 0 0 8px rgba(13,13,13,.62),var(--ticket-glass-shadow,inset 0 1px 0 rgba(255,255,255,.105),inset 0 -1px 0 rgba(255,255,255,.06),inset 0 0 18px rgba(255,255,255,.05),0 10px 22px rgba(0,0,0,.22));pointer-events:auto}
