...
.ai-thinking-row[data-state=generating_voice] .ai-thinking-head{
  gap:7px;
}
...
@media(prefers-reduced-motion:reduce){.ai-coding-workbench,.ai-coding-event,.ai-coding-result-card,.ai-diff-file summary::before{animation:none!important;transition:none!important;transform:none!important}.ai-coding-workbench{opacity:1!important}}
